...
#define N2N_AFLAGS_RELAY_WILLING_NO  0x0800 /* edge is unwilling to act as the community relay (SN won't pick it) */
#define N2N_AFLAGS_RELAY_WILLING_YES 0x1000 /* edge is willing to act as the community relay (SN prefers it) */
...
#define N2N_AFLAGS_RELAY           0x0010  /* this peer is the community's relay server (mini-SN):
                                              the two endpoints must register to it and use it
                                              when their direct path fails */
#define N2N_AFLAGS_RELAY_MEMBER    0x0020  /* sent to the relay server only: this peer will register
                                              to the relay. A NAT2 relay pre-opens its NAT by sending
                                              a REGISTER toward this peer's socket first */
